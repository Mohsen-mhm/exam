...
<div id="app">
    <nav
        ...
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="{{ url('/') }}" class="flex items-center">
                <span
                    class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{{ config('app.name', 'Quiz') }}</span>
            </a>
    ...
    <main class="flex justify-center align-center dark:bg-gray-800 pt-10 pb-10 h-screen">
        @yield('content')
    </main>
</div>
</body>
