...
<div
    ...
    @if (session('resent'))
        <div id="toast-success"
            ...
            <div class="ml-3 text-sm font-normal">A fresh verification link has been sent to your email address.</div>
        </div>
    @endif
    <h4 class="text-lg font-medium text-gray-900 dark:text-white">Before proceeding, please check your email for a verification link.</h4>
