...
@section('content')
    ...
    <div class="flex justify-center">
        <div
            ...
            <h5 class="text-xl mb-3 font-medium text-gray-900 dark:text-white">Edit question</h5>

            <form method="POST" action="{{ route('admin.questions.update', $question) }}" class="w-full"
                  autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="grid md:grid-cols-2 md:gap-6 mb-3">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="o1" id="option1"
                               ...
                               placeholder=" " value="{{ old('option1', $question->o1) }}" required/>
                        <label for="option1"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="o2" id="option2"
                               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " value="{{ old('option2', $question->o2) }}" required/>
                        <label for="option2"
                               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Option
                            2</label>
                        @error('option2')
                ...
                <div class="grid md:grid-cols-2 md:gap-6 mb-3">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="o3" id="option3"
                               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " value="{{ old('option3', $question->o3) }}" required/>
                        <label for="option3"
                               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Option
                            3</label>
                        @error('option3')
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="o4" id="option4"
                               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" " value="{{ old('option4', $question->o4) }}" required/>
                        <label for="option4"
                               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Option
                            4</label>
                        @error('option4')
